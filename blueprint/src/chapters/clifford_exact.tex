...
\begin{lemma}[Two-qubit cosine--sine decomposition]
  \label{lem:cs_exists_2q}
  \lean{TwoControl.CosineSine.cosinesine_exists}
  \leanok
  Every two-qubit unitary admits a product decomposition into two
  block-diagonal unitary factors and a conditional $R_y$ rotation.
\end{lemma}

\begin{proof}
  \leanok
  This is the dimension-four specialization of the constructive
  cosine--sine decomposition developed in the Lean source.
\end{proof}
