...
@[simp] lemma kronVec_vec2_apply_0 (a b : Vec 2) :
  ...
  have hdiv : (((0 : Fin (2 * 2))).divNat : Fin 2) = 0 := by decide
  have hmod : (((0 : Fin (2 * 2))).modNat : Fin 2) = 0 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec2_apply_1 (a b : Vec 2) :
    kronVec a b 1 = a 0 * b 1 := by
  have hdiv : (((1 : Fin (2 * 2))).divNat : Fin 2) = 0 := by decide
  have hmod : (((1 : Fin (2 * 2))).modNat : Fin 2) = 1 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec2_apply_2 (a b : Vec 2) :
    kronVec a b 2 = a 1 * b 0 := by
  have hdiv : (((2 : Fin (2 * 2))).divNat : Fin 2) = 1 := by decide
  have hmod : (((2 : Fin (2 * 2))).modNat : Fin 2) = 0 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec2_apply_3 (a b : Vec 2) :
    kronVec a b 3 = a 1 * b 1 := by
  have hdiv : (((3 : Fin (2 * 2))).divNat : Fin 2) = 1 := by decide
  have hmod : (((3 : Fin (2 * 2))).modNat : Fin 2) = 1 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec4_2_apply_0 (v : Vec 4) (w : Vec 2) :
    kronVec v w 0 = v 0 * w 0 := by
  have hdiv : (((0 : Fin (4 * 2))).divNat : Fin 4) = 0 := by decide
  have hmod : (((0 : Fin (4 * 2))).modNat : Fin 2) = 0 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec4_2_apply_1 (v : Vec 4) (w : Vec 2) :
    kronVec v w 1 = v 0 * w 1 := by
  have hdiv : (((1 : Fin (4 * 2))).divNat : Fin 4) = 0 := by decide
  have hmod : (((1 : Fin (4 * 2))).modNat : Fin 2) = 1 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec4_2_apply_2 (v : Vec 4) (w : Vec 2) :
    kronVec v w 2 = v 1 * w 0 := by
  have hdiv : (((2 : Fin (4 * 2))).divNat : Fin 4) = 1 := by decide
  have hmod : (((2 : Fin (4 * 2))).modNat : Fin 2) = 0 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec4_2_apply_3 (v : Vec 4) (w : Vec 2) :
    kronVec v w 3 = v 1 * w 1 := by
  have hdiv : (((3 : Fin (4 * 2))).divNat : Fin 4) = 1 := by decide
  have hmod : (((3 : Fin (4 * 2))).modNat : Fin 2) = 1 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec4_2_apply_4 (v : Vec 4) (w : Vec 2) :
    kronVec v w 4 = v 2 * w 0 := by
  have hdiv : (((4 : Fin (4 * 2))).divNat : Fin 4) = 2 := by decide
  have hmod : (((4 : Fin (4 * 2))).modNat : Fin 2) = 0 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec4_2_apply_5 (v : Vec 4) (w : Vec 2) :
    kronVec v w 5 = v 2 * w 1 := by
  have hdiv : (((5 : Fin (4 * 2))).divNat : Fin 4) = 2 := by decide
  have hmod : (((5 : Fin (4 * 2))).modNat : Fin 2) = 1 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec4_2_apply_6 (v : Vec 4) (w : Vec 2) :
    kronVec v w 6 = v 3 * w 0 := by
  have hdiv : (((6 : Fin (4 * 2))).divNat : Fin 4) = 3 := by decide
  have hmod : (((6 : Fin (4 * 2))).modNat : Fin 2) = 0 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec4_2_apply_7 (v : Vec 4) (w : Vec 2) :
    kronVec v w 7 = v 3 * w 1 := by
  have hdiv : (((7 : Fin (4 * 2))).divNat : Fin 4) = 3 := by decide
  have hmod : (((7 : Fin (4 * 2))).modNat : Fin 2) = 1 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec2_4_apply_0 (v : Vec 2) (w : Vec 4) :
    kronVec v w 0 = v 0 * w 0 := by
  have hdiv : (((0 : Fin (2 * 4))).divNat : Fin 2) = 0 := by decide
  have hmod : (((0 : Fin (2 * 4))).modNat : Fin 4) = 0 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec2_4_apply_1 (v : Vec 2) (w : Vec 4) :
    kronVec v w 1 = v 0 * w 1 := by
  have hdiv : (((1 : Fin (2 * 4))).divNat : Fin 2) = 0 := by decide
  have hmod : (((1 : Fin (2 * 4))).modNat : Fin 4) = 1 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec2_4_apply_2 (v : Vec 2) (w : Vec 4) :
    kronVec v w 2 = v 0 * w 2 := by
  have hdiv : (((2 : Fin (2 * 4))).divNat : Fin 2) = 0 := by decide
  have hmod : (((2 : Fin (2 * 4))).modNat : Fin 4) = 2 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec2_4_apply_3 (v : Vec 2) (w : Vec 4) :
    kronVec v w 3 = v 0 * w 3 := by
  have hdiv : (((3 : Fin (2 * 4))).divNat : Fin 2) = 0 := by decide
  have hmod : (((3 : Fin (2 * 4))).modNat : Fin 4) = 3 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec2_4_apply_4 (v : Vec 2) (w : Vec 4) :
    kronVec v w 4 = v 1 * w 0 := by
  have hdiv : (((4 : Fin (2 * 4))).divNat : Fin 2) = 1 := by decide
  have hmod : (((4 : Fin (2 * 4))).modNat : Fin 4) = 0 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec2_4_apply_5 (v : Vec 2) (w : Vec 4) :
    kronVec v w 5 = v 1 * w 1 := by
  have hdiv : (((5 : Fin (2 * 4))).divNat : Fin 2) = 1 := by decide
  have hmod : (((5 : Fin (2 * 4))).modNat : Fin 4) = 1 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec2_4_apply_6 (v : Vec 2) (w : Vec 4) :
    kronVec v w 6 = v 1 * w 2 := by
  have hdiv : (((6 : Fin (2 * 4))).divNat : Fin 2) = 1 := by decide
  have hmod : (((6 : Fin (2 * 4))).modNat : Fin 4) = 2 := by decide
  simp [kronVec, hdiv, hmod]

@[simp] lemma kronVec_vec2_4_apply_7 (v : Vec 2) (w : Vec 4) :
    kronVec v w 7 = v 1 * w 3 := by
  have hdiv : (((7 : Fin (2 * 4))).divNat : Fin 2) = 1 := by decide
  have hmod : (((7 : Fin (2 * 4))).modNat : Fin 4) = 3 := by decide
  simp [kronVec, hdiv, hmod]
