...
Supports the `G₁/G₂` track of the universality proof
...
theorem axisRotation_zero (n : EuclideanSpace ℝ (Fin 3)) :
    axisRotation n 0 = 1 := by
  unfold axisRotation
  simp

open scoped Matrix.Norms.Operator in
theorem axisRotation_add (n : EuclideanSpace ℝ (Fin 3)) (φ ψ : ℝ) :
...
theorem axisRotation_nat_pow (n : EuclideanSpace ℝ (Fin 3)) (φ : ℝ) (k : ℕ) :
...
theorem axisRotation_int_mul_two_pi
...
theorem axisRotation_add_int_mul_two_pi
